...
public sealed partial class WorldConsequenceApplier
{
    ...
    private static readonly Dictionary<string, Func<WorldConsequenceApplier, WorldConsequence, WorldConsequenceApplyResult>> FamilyDispatch =
        new(StringComparer.Ordinal)
        {
            ...
            [WorldConsequenceTypes.OfferBargain] = static (a, c) => a.ApplyOfferBargain(c),
            [WorldConsequenceTypes.AcceptBargain] = static (a, c) => a.ApplyAcceptBargain(c),
            [WorldConsequenceTypes.FulfillBargain] = static (a, c) => a.ApplyFulfillBargain(c),
            [WorldConsequenceTypes.AlterItem] = static (a, c) => a.ApplyAlterItem(c),
            [WorldConsequenceTypes.ResolveCost] = static (a, c) => a.ApplyResolveCost(c),
