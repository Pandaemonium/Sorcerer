...
public sealed partial class GameSession
{
    ...
    private ActionResult CompleteRunIfNeeded(ActionResult result)
    {
        ...
        {
            // Death is terminal in both modes (Classic permadeath; Roleplay reloads an ordinary
            // save). The body is disposed of in the register of whoever struck it down (Phase 2.6).
